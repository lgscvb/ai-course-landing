...
const items: TOCItem[] = [
  { id: "day-1", label: "Day 1", sub: "認識 AI 的五感", color: "blue" },
  { id: "day-2", label: "Day 2", sub: "AI 自動化實戰", color: "blue" },
  { id: "day-3", label: "Day 3", sub: "AI 多媒體入門", color: "purple" },
  {
    id: "day-4",
    label: "Day 4",
    sub: "AI 多媒體進階 + 整合",
...
/**
 * Sticky table of contents for /syllabus.
 *
 ...
 * rootMargin -30%/-60% biases the active band to the upper-middle of the
 * viewport so the active link follows the section a user is actually
 * reading rather than the one barely poking into view.
 */
export default function SyllabusTOC() {
  const [active, setActive] = useState<string>("day-1");
  ...
  useEffect(() => {
    ...
    const io = new IntersectionObserver(
      (entries) => {
        // Pick the entry whose top is closest to (and above) our band.
      ...
      {
        // Active band sits in the upper-middle: 30% from top, 60% from bottom.
