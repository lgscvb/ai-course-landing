...
const marketStats = [
  {
    ...
    source: "-- 經濟部調查",
    counter: { kind: "number" as const, value: 92, suffix: "%" },
  },
  {
    value: "99%",
    ...
    label: "的人在「撞牆期」就放棄",
    source: "-- AI 使用者旅程研究",
    counter: { kind: "number" as const, value: 99, suffix: "%" },
  },
  {
    value: "80/20",
  ...
  },
  {
    ...
    source: "-- 政府全額補助",
    counter: { kind: "number" as const, value: 0, prefix: "$" },
  },
];
    ...
    <>
          ...
          <div className="mx-auto mt-12 grid max-w-3xl grid-cols-1 gap-5 sm:grid-cols-2">
            {painPoints.map((point, i) => (
              <Reveal key={i} delay={i * 80}>
                <div className="card-lico flex h-full items-start gap-4 border border-border-light bg-white p-6 will-change-transform">
          ...
          <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2">
            {useCases.map((uc, i) => (
              <Reveal key={i} delay={(i % 2) * 80}>
                <div className="card-lico h-full border border-border-light bg-light-bg p-6 will-change-transform">
                  {/* Industry pill */}
                  <span
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 grid grid-cols-2 gap-6 sm:grid-cols-4">
            {marketStats.map((stat, i) => (
              <Reveal key={i} delay={i * 80}>
                <div className="glow-card h-full rounded-[24px] p-6 text-center will-change-transform">
                  <p className={`text-5xl font-black tracking-[-0.03em] ${stat.valueClass}`}>
                    {stat.counter.kind === "number" ? (
                      <CountUp
      ...
      <section className="bg-white py-20 sm:py-28">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 grid grid-cols-1 gap-8 md:grid-cols-3">
            {highlights.map((h, i) => (
              <Reveal key={i} delay={i * 80}>
                <div className="card-lico h-full border border-transparent bg-light-bg p-8 will-change-transform hover:border-[#0071e3]/10">
      ...
      <section className="bg-light-bg py-20 sm:py-28">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-14">
            <Reveal delay={80}>
              <div className="card-lico mx-auto max-w-3xl border border-border-light bg-white p-8 will-change-transform sm:p-12">
      ...
      <section className="bg-hero-bg py-20 sm:py-28">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 grid grid-cols-1 gap-6 sm:grid-cols-2">
            {outcomes.map((o, i) => (
              <Reveal key={o.num} delay={(i % 2) * 80}>
                <div className="glow-card h-full rounded-[24px] p-6 will-change-transform">
      ...
      <section className="bg-light-bg py-20 sm:py-28">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-12 grid max-w-3xl grid-cols-1 gap-6 sm:grid-cols-2">
            {/* Option A -- 工讀生 */}
            <Reveal delay={0}>
              <div className="card-lico h-full border border-border-light bg-white p-8 will-change-transform">
            ...
            {/* Option B -- AI 工具（漸層卡，hover shadow 用 accent 色） */}
            <Reveal delay={80}>
              <div className="relative h-full overflow-hidden rounded-[24px] bg-gradient-to-br from-[#0071e3] to-[#005bb5] p-8 text-white transition-all duration-[350ms] [transition-timing-function:var(--lico-ease)] will-change-transform hover:-translate-y-1.5 hover:shadow-[0_20px_50px_rgba(0,113,227,0.3)]">
                {/* 推薦 badge */}
